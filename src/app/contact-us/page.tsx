          ...
          <div className="container px-6 py-12 mx-auto">
            ...
            <div className="grid grid-cols-1 gap-4 mt-10 lg:grid-cols-4 sm:grid-cols-2 ">
              <div className="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                ...
                <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">theonepercentbhu@gmail.com</p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                ...
                <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">72H2+4WF, Banaras Hindu University, Varanasi, Uttar Pradesh, 221005</p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                ...
                <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">+91 8512 80017, +91 78003 36600</p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                ...
                <h2 className="mt-4 text-base font-medium text-gray-800 dark:text-white">Instagram</h2>
                <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                  Follow us on Instagram.
                </p>
                <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">@ig_the1percentclub</p>
              </div>
            </div>
          </div>
        </section>
