                    ...
                    <section className="bg-white ">
                        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center pb-0 lg:px-6">
                            <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
                                <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-neutral  capitalize">About one% Club</h2>
                                <p className="font-light text-gray-500 sm:text-xl ">Welcome to The One% Club – your premier destination for UPSC exam preparation excellence.
                        ...
                        <div className=" px-4 mx-auto max-w-screen-xl text-center lg:pb-16 lg:px-6 pt-0">
                            <div className="mx-auto mb-8 max-w-screen-sm">
                                <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-neutral  capitalize">Our Team</h2>
                            ...
                            <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                <div className="text-center text-gray-500 ">
                                    ...
                                    <div className='relative bottom-6'>
                                        ...
                                        <h3 className="mb-1 text-2xl font-bold tracking-tight text-neutral">
